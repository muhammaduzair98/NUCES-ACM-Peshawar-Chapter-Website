 ...
 *
 * @package elements/social-profile/view/template-2
...
if ( ! empty( $primary ) ) : ?>
    <style>
        #eplus-social-profile-<?php echo esc_attr( $unique_id ) ?> > .eplus-social-profile-inner {
...
<div class="eplus-social-profile-<?php echo esc_attr( $style ) ?>"
    ...
    <div class="eplus-social-profile-inner">
