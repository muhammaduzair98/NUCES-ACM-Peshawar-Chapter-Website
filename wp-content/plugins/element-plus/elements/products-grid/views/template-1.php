 ...
 *
 * @package elements/products/view/template-1
...
if ( ! empty( $primary_color ) || ! empty( $secondary_color ) ) : ?>
    <style>
        ...
        <?php if( $style == '2' ) : ?>
        #eplus-products-grid-<?php echo esc_attr( $unique_id ); ?> .product-button > a {
...
<div id="eplus-products-grid-<?php echo esc_attr( $unique_id ); ?>"
     class="eplus-products-grid-<?php echo esc_attr( $style ); ?>">
