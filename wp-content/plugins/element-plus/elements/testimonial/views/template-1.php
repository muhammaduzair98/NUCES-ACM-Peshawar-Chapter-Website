...
$testi_img_url = wp_get_attachment_image_url( eplus()->get_shortcode_atts( 'img' ) );
...
<div id="eplus-testimonial<?php echo esc_attr( $unique_id ); ?>"
    ...
    <div class="eplus-testi-footer">
		<?php if ( ! empty( $testi_img_url ) ) : ?>
            <div class="eplus-testi-img">
                <img src="<?php echo esc_url( $testi_img_url ); ?>" alt="<?php echo esc_attr( $name ); ?>">
            </div>
		<?php endif; ?>
